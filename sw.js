const CACHE = 'paper-reader-v85';
const CORE = ['/', '/index.html', '/reader-ui.css?v=32', '/reader-v3.css?v=5', '/app.js?v=72', '/ai-worker.js?v=1', '/manifest.json', '/icon-192.png', '/icon-512.png'];
