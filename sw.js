const CACHE = 'paper-reader-v86';
const CORE = ['/', '/index.html', '/reader-ui.css?v=32', '/reader-v3.css?v=6', '/app.js?v=73', '/ai-worker.js?v=1', '/manifest.json', '/icon.svg', '/icon-192.png', '/icon-512.png'];
