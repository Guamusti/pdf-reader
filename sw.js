const CACHE = 'paper-reader-v99';
const SHARE_CACHE = 'paper-share';
const CORE = ['/', '/index.html', '/reader-ui.css?v=32', '/reader-v3.css?v=8', '/reader-v6.css?v=10', '/app.js?v=86', '/storage.js?v=1', '/sync.js?v=1', '/references.js?v=3', '/ai-worker.js?v=1', '/manifest.json', '/icon.svg', '/icon-192.png', '/icon-512.png'];
