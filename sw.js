const CACHE = 'paper-reader-v87';
const CORE = ['/', '/index.html', '/reader-ui.css?v=32', '/reader-v3.css?v=7', '/app.js?v=74', '/ai-worker.js?v=1', '/manifest.json', '/icon.svg', '/icon-192.png', '/icon-512.png'];
